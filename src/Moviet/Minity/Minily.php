...
use Moviet\Minity\Providers\JS;
use Moviet\Minity\Providers\CSS;
use Moviet\Minity\Providers\IMG;
use Moviet\Minity\Providers\JSFile;
use Moviet\Minity\Providers\CSSFile;
...
class Minily
{
    ...
    public function setConfig(array $config)
    {
        ...
        if (!isset($config['jsf_minify'])) {
            throw new Exceptions\InvalidArgumentException(sprintf('Missing option %s', 'jsf_minify'));
        }
     ...
     * @return this
     */
    public function jsf($files, $name, array $attributes = [])
    {
        $this->provider = new JsFile([
            'asset' => $this->config['asset'],
            'minily' => $this->config['jsf_minify'],
            'attributes' => $attributes
        ]);
     ...
     * @return this
     */
    public function jsfDir($dir, $name, $recursive = false, array $attributes = [])
    {
        $this->provider = new JsFile([
            'asset' => $this->config['asset'],
            'minily' => $this->config['jsf_minify'],
     ...
     * @return this
     */
    public function cssfile($files, $name, array $attributes = [])
    {
        $this->provider = new CSSFile([
            'asset' => $this->config['asset'],
            'minily' => $this->config['csf_minify'],
            'attributes' => $attributes
        ]);
     ...
     * @return this
     */
    public function cssfileDir($dir, $name, $recursive = false, array $attributes = [])
    {
        $this->provider = new CSSFile([
            'asset' => $this->config['asset'],
            'minily' => $this->config['csf_minify'],
